...
public record TirePhysicsData(
    ...
    public static final TirePhysicsData TRUCK        = new TirePhysicsData(1.1f, 1.1f, 0.3f, 0.9f);
    ...
    public static final TirePhysicsData VINTAGE      = new TirePhysicsData(0.9f, 1.0f, 0.4f, 0.35f);
